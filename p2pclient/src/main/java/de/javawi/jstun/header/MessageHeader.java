...
public class MessageHeader implements MessageHeaderInterface {
	...
	public static MessageHeader parseHeader(byte[] data) throws MessageHeaderParsingException {
		try {
			...
			switch (type) {
				case BINDINGREQUEST: mh.setType(MessageHeaderType.BindingRequest); Log.d(TAG, "Binding Request received."); break;
				case BINDINGRESPONSE: mh.setType(MessageHeaderType.BindingResponse); Log.d(TAG, "Binding Response received."); break;
				case BINDINGERRORRESPONSE: mh.setType(MessageHeaderType.BindingErrorResponse); Log.d(TAG, "Binding Error Response received."); break;
				case SHAREDSECRETREQUEST: mh.setType(MessageHeaderType.SharedSecretRequest); Log.d(TAG, "Shared Secret Request received."); break;
				case SHAREDSECRETRESPONSE: mh.setType(MessageHeaderType.SharedSecretResponse); Log.d(TAG, "Shared Secret Response received."); break;
				case SHAREDSECRETERRORRESPONSE: mh.setType(MessageHeaderType.SharedSecretErrorResponse); Log.d(TAG, "Shared Secret Error Response received.");break;
